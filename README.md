# Created from AL-Go Per Tenant Extension Template
This [template repository](https://github.com/SPLTBC/ALGO) can be used for managing AppSource Apps for Business Central.
